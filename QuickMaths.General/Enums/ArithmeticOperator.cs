...
{
    private static readonly IArithmeticOperator s_plusOperator;
    private static readonly IArithmeticOperator s_minusOperator;
    private static readonly IArithmeticOperator s_multiplyOperator;
    private static readonly IArithmeticOperator s_divideOperator;
    private static readonly IArithmeticOperator s_powerOperator;
    private static readonly IArithmeticOperator s_noneOperator;
    ...
    {
        s_plusOperator = new CustomOperator(PLUS_MINUS_OPERATORS_PRIORITY_VALUE, true, true, PLUS_OPERATOR_CHAR_VIEW, true);
        s_minusOperator = new CustomOperator(PLUS_MINUS_OPERATORS_PRIORITY_VALUE, true, true, MINUS_OPERATOR_CHAR_VIEW, false);
        s_multiplyOperator = new CustomOperator(MULTIPLY_DIVIDE_OPERATOR_PRIORITY_VALUE, true, true, MULTIPLY_OPERATOR_CHAR_VIEW, true);
        s_divideOperator = new CustomOperator(MULTIPLY_DIVIDE_OPERATOR_PRIORITY_VALUE, true, false, DIVIDE_OPERATOR_CHAR_VIEW, false);
        s_powerOperator = new CustomOperator(POWER_OPERATOR_PRIORITY_VALUE, true, false, POWER_OPERATOR_CHAR_VIEW, false);
        s_noneOperator = new CustomOperator(NONE_OPERATOR_PRIORITY_VALUE, false, true, NONE_OPERATOR_CHAR_VIEW, true);
    }
    ...
    private sealed class CustomOperator : IArithmeticOperator
    {
        ...
        public CustomOperator(int operatorPriority, bool isOperatorIsBinary, bool isOperatorIsUnary, char operatorCharView, bool isSkipOnBeginInStringView)
        {
